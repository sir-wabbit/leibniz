...
//    SingletonOf.witness(zIsInhabited[N].contradicts, As.refl[FZ[N]], zIsContractible[N].proposition)
//
...
//    SingletonOf.witness(sIsInhabited[N, FN].contradicts, As.refl[FS[N, FN]], sIsContractible[N, FN].proposition)
//}